...
const createHomework = async () => {
    ...
    await supabase
        .from("homework")
        .insert({ content: homeworkContent.value, lessonId: lesson.id })
        .then(async () => {
            await getHomework();
        ...
        <div v-else class="container">
            ...
            <div class="mb-6 flex justify-between items-center">
                ...
                <div class="flex items-center">
                    ...
                    <Modal
                        :condition="subject.userId == props.user?.id || props.user.admin"
                        text="Eliminar"
            ...
            <div v-else>
                ...
                <div
                    v-else
                    class="relative box my-6 whitespace-nowrap overflow-x-scroll"
                ...
                >
                    ...
                    <Modal
                        :condition="subject.userId == props.user?.id || props.user.admin"
                        class="text-sm !text-left text-red-600 cursor-pointer mt-2"
                        title="Eliminar material"
                        text="Eliminar"
                        ref="deleteMaterialModal"
                    >
                        <p class="py-6">
                        ...
                        <button
                            class="btn btn-danger w-full"
                            @click="() => handleMaterialDelete(i, material.id)"
                        >
                            <img
            ...
            <div class="mt-2">
                <img
                    v-if="homeworkLoading"
                    src="/loading.svg"
                    class="w-20 mt-16 block m-auto"
                />
                <div v-else>
                    ...
                    <div v-else>
                        <div v-for="(hw, i) in homework" class="box my-6">
                            <HomeworkEntries :userIsProfesor="props.user?.id == subject.userId || props.user.admin" :user="props.user" :homework="hw" />
                            <div class="text-sm float-right mt-1 text-gray-600">
                                {{
                                    new Intl.DateTimeFormat("es-AR", {
                                        year: "numeric",
                                        month: "long",
