...
<template>
    ...
    <div v-if="data.full_name">
        ...
        <div v-if="isAdmin">
            ...
            <h3 class="h3 mt-6 mb-2">Usuarios</h3>
            <hr />
            <User
                ...
                >
                    <DisclosurePanel>
                        <NuxtLink
                            ...
                            :to="`a/${year}/trimestre/${trimester.id}/periodo/${period[i].id}`"
                            class="block px-6 py-4 border border-dashed rounded-xl my-6 first:mt-2"
                        >
                            Periodo #{{ j + 1 }} • {{ period[i].title }}
                        </NuxtLink>
                    </DisclosurePanel>
                </transition>
            </Disclosure>
