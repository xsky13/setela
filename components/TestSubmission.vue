    ...
    <div class="box !flex justify-between items-center my-7">
        ...
        <div class="flex items-center">
            ...
            >
                ...
                <button
                    @click="() => props.deleteTestSubmission(testSubmission.id, i)"
                    class="btn btn-danger w-full"
                >
                    <img
                        v-if="props.deleteTestSubmissionLoading"
                        width="20"
            ...
            <Modal
                ...
                width="w-7/12"
                :openFunction="() => openCorrectModal(testSubmission, i)"
                ref="correctTestSubmissionModalRef"
            >
                <div
                    v-for="answer in props.testAnswers.filter(
                ...
                <div class="my-8 md:flex items-center">
                    ...
                    <input
                        ...
                        v-model="currentlyCorrecting.score"
                    />
                </div>
                <button
                ...
                >
                    <img
                        v-if="correctTestSubmissionLoading"
                        src="/loading_white.svg"
                        width="20"
                    />
